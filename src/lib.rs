...
#[derive(Debug)]
pub struct CoinWalletProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CoinWalletProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CoinWallet processing");
    
    let mut processor = CoinWalletProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CoinWalletProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CoinWalletProcessor::new(false);
